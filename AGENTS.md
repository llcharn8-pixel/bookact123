...
ReadAct: a lightweight reading-to-action tracker where readers log book/article titles, key points, and actionable steps with achievable results — core CRUD first, AI extraction later.
